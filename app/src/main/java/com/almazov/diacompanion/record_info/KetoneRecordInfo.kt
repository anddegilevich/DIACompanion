...
import kotlinx.android.synthetic.main.fragment_ketone_record_info.*

class KetoneRecordInfo : Fragment() {

    private val args by navArgs<KetoneRecordInfoArgs>()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ketone_record_info, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        appDatabaseViewModel.readKetoneRecord(args.selectedRecord.id).observe(viewLifecycleOwner, Observer { record ->
            ...
            tv_ketone.text = record.ketone.toString()
        ...
        btn_edit.setOnClickListener{
            val action = KetoneRecordInfoDirections.actionKetoneRecordInfoToKetoneAddRecord(args.selectedRecord)
